...
public class GoodsController {
    ...
    public ResponseEntity<PageResult<SpuBo>> querySpuByPage(
        ...
        PageResult<SpuBo> spuBoPageResult = this.goodsService.querySpuByPage(key,saleable,page,rows);
    ...
    /**
     * 新增商品
     * 注意前端传递的是json对象 所以要加上RequestBody
     * @param spuBo
     * @return
     */
    @PostMapping("goods")
    ...
    /**
     * // 同步发起请求，根据spuId查询商品详情(spuDetail)和skus
